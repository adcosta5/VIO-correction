...
def ori_pos_orienternet(image, prior_address, seq):
    ...
    image = f"../../datasets/BIEL/{seq}/image_0/000000.png" # This needs to be corrected
    image, camera, gravity, proj, bbox = demo.read_input_image( # Auto extracts camera calibration parameters
    image,
